...
<div class="modal fade" id="contact" tabinex="-1" role="dialog" aria-hidden="true">
	...
	<div class="container">
	 ...
	 <div class="row">
            ...
            <div class="col-md-5">
				<img alt="xxx" src="flowervases/ClassicElegantCeramicVase.jpg">
			</div>
            <div class="col-md-5">
			<br><br>
				Description :<br><br>
			<p> This ceramic vase is a beautiful decorative piece which can be placed anywhere at?home or at your office.
			The color suits every ambiance. It is ideal for gifting and suitable for homes, offices and can be displayed with or without flowers.</p>
				<br>
				Brand  &nbsp;&nbsp;: Classic<br>
				Color  &nbsp;&nbsp;&nbsp;: Black<br>
				Pieces &nbsp;: 3<br><br><br>
				<input type="button" class="btn btn-success" value="Add To Cart"  onclick='addtocart("<%= i%>")' />
				<a href="flowervases.html"><input type="button" class="btn btn-success" value="Back"   /></a>
