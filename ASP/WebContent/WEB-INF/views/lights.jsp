...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    ghpages_end -->
    <script src="resources/Filters/data/lights.js" type="text/javascript"></script>
  ...
  <div class="container">
   ...
   <!-- <div id="container1">
      ...
      <div class="sidebar col-span-3">
        <div class="row">
          <h4 class="col-span-6"> Lights (<span id="total_movies">250</span>)</h4>
        ...
        <div class="criteria" id="genre_criteria">
          ...
          <div class="checkbox">
            <label>
              <input type="checkbox" value="CeilLights">Ceil Lights
            </label>
            </div><div class="checkbox">
            <label>
              <input type="checkbox" value="HangLights"> Hanging Lights
            </label>
            </div><div class="checkbox">
            <label>
              <input type="checkbox" value="HomeLights"> Home Lights
            </label>
            </div>
    ...
    <script id="movie-template" type="text/html">
      ...
      <div class="col-span-4 movie">
        <div class="thumbnail">
          ...
          <div class="caption" >
            <h4><div id="name<%= i%>"> name </div></h4>
           
            <div class="">
              <dl>
                <dt></dt>
                <br><center><dd><a href="desc.jsp"><img onclick="addtocart1(this.src);" src="<%= image %>" id="image<%= i%>" value="<%= image %>" /></a></dd></center><br>
