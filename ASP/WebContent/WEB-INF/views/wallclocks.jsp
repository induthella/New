...
<head>
    ...
    ghpages_end -->
    <script src="resources/Filters/data/movies.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        //alert("r");
            var results = document.getElementById("searchdatalist");
            var hr = new XMLHttpRequest();
            hr.open("GET", "searchdatalist.json", true);
              ...
              //alert("rr");
                if(hr.readyState == 4 && hr.status == 200) {
                  ...
                  //alert("rrrr");
                    for(var obj in data){
                     // alert("obj");
                        results.innerHTML += "<option value= '"+data[obj].name+"'></option>";
	    	...
	    	//alert("display")
	    		...
	    		for(var obj in data){
	    			//if(data[obj].category==protype)
	    			{
	    				...
	    				id=data[obj].pid;
	    				link="details?id="+id
	    				results += "<div class='col-span-4 movie'><div class='thumbnail'>"+
	    		            "<span class='label label-success rating'><div id='price ' >"+data[obj].price+"</div>"+
	    		            "<i class='glyphicon glyphicon-usd'></i></span>"+
	    		          "<div class='caption' > <h4><div id='namei'> "+data[obj].pname+" </div></h4>"+
	    		            "<div class=''><dl><dt></dt>"+
	    		                "<br><center><dd><a href='desc.html'><img onclick='addtocart1(this.src);' src='data:image/png;base64,"+ data[obj].pimage +"' id='image i' value='image' /></a></dd></center><br>"+
	    		                "<dd><a href='javascript:void(0)' onclick=toggle_visibility('popupBoxOnePosition');><input type='button' class='btn btn-success' value='Add To Cart' onclick='addtocart("+data[obj].pid+")' /></a>"+
  ...
  <div class="navigation">
    <nav role="navigation" class="navbar navbar-default">
      ...
      <div id="navbarCollapse" class="collapse navbar-collapse">
      	<ul class="nav navbar-nav"><li><a href="index.html" class="navbar-brand"><font color="orange">I</font>nterior <font color="orange">D</font>esign</a></li></ul>
  ...
  <div class="container">
    ...
    <div id="container1">
      ...
      <div class="sidebar col-span-3">
        <div class="row">
          <h4 class="col-span-6"> Wall Clocks (<span id="total_movies"></span>)</h4>
        ...
        <div>
          ...
          <input type="text" id="searchbox" placeholder="Search..." list="searchdatalist"  >
          <span class="glyphicon glyphicon-search search-icon"></span>

			 <datalist id="searchdatalist">
		  		<option value="Clock-animal wall clock"></option>
          		<option value="Clock-House Wall Clock"></option>
          		<option value="Clock-aa"></option>
        ...
        <div class="criteria">
			<h4>Categories </h4>
               <ul class="category" style="list-style-type:none">
				<li>
                   <a href="wallclocks.html" class="" style="color:black">Wall CLocks</a></li>
                <li>   <a href="flowervases.html" class="" style="color:black">Flower vases</a></li>
                <li>   <a href="walldecors.html" class="" style="color:black">Wall Decors</a></li>
                 <li>  <a href="lights.html" class="" style="color:black">Lights</a></li>
 				</ul>
        ...
        <div class="criteria" id="genre_criteria">
          ...
          <div class="checkbox">
            <label>
              <input type="checkbox" value="Timeline"> Time line
            </label>
            </div><div class="checkbox">
            <label>
              <input type="checkbox" value="Random"> Random
            </label>
            </div><div class="checkbox">
            <label>
              <input type="checkbox" value="Top 10"> Top 10
            </label>
            </div>
            </div>
