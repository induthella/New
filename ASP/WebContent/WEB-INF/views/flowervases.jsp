...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    ghpages_end -->
    <script src="resources/Filters/data/flovase.js" type="text/javascript"></script>
    ...
    <div id="container1">
     <!-- <div class="view-controls-list" id="viewcontrols">
      ...
      <div class="sidebar col-span-3">
        <div class="row">
          <h4 class="col-span-8"> Flower Vases (<span id="total_movies">250</span>)</h4>
          ...
          <div class="thumbnail">
            ...
            <div class="caption" >
              ...
              <div class="">
                <dl>
                  <dt></dt>
                  <br><center><dd><a href="desc.html"><img  src="<%= image %>" id="image<%= i%>" value="<%= image %>" /></a></dd></center><br>
